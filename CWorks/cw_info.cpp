...
void InfoCW4()
{
	...
	std::cout << std::endl
		...
		<< "–-------------------------------------------------------------" << std::endl
		<< "Содержание задания:" << std::endl
		<< "Найти в тексте все повторяющиеся подстроки длиннее заданной пользователем величины" << std::endl
		<< "(например, длиннее пяти символов)." << std::endl
		<< "Заменить все вхождения подстроки кроме первого специальной сигнатурой: " << std::endl
		<< "{индекс первого символа оригинальной строки, длина цепочки}." << std::endl
		<< "Перед заменой убедиться, что в тексте нет комбинаций символов," << std::endl
		<< "которые могут ошибочно восприниматься как формируемая сигнатура." << std::endl
		<< "Предусмотреть режим восстановления оригинального текста." << std::endl
		<< "Пример : текст «тестовая строка» должен быть заменен на текст" << std::endl
		<< "«тестовая{ 3, 2 }рока» при условии, что рассматриваются подстроки," << std::endl
		<< "начиная с длины в два символа." << std::endl
		<< "–-------------------------------------------------------------" << std::endl;
}